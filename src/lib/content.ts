...
export const dict = {
  id: {
    ...
    contact: {
      eyebrow: "Kontak",
      index: "06",
      title: "Ada lowongan atau proyek? Cerita saja dulu.",
      desc: "Jam respon tercepat Senin sampai Sabtu, jam kerja WIB, lewat WhatsApp. Untuk lamaran formal pakai email. Contoh kode ada di GitHub.",
      cards: [
      ...
      formDesc: "Tanpa database. Tombol di bawah membuka Email atau WhatsApp dengan teks sudah terisi.",
      namePh: "Nama Anda",
      msgPh: "Halo Usman, saya dari ... Kami butuh bantuan untuk ...",
  ...
  en: {
    ...
    contact: {
      eyebrow: "Contact",
      index: "06",
      title: "Hiring or have a project? Just tell me first.",
      desc: "Fastest reply Mon to Sat, working hours WIB, on WhatsApp. For formal applications use email. Sample code is on GitHub.",
      cards: [
        { label: "Email", value: "usman@gmail.com", href: "mailto:usman@gmail.com" },
        { label: "WhatsApp", value: "0819-1684-8478", href: "https://wa.me/6281916848478" },
        { label: "GitHub", value: "@wsprfme", href: "https://github.com/wsprfme" },
      ...
      formDesc: "No database. Buttons below open Email or WhatsApp with prefilled text.",
      namePh: "Your name",
      msgPh: "Hi Usman, I'm from ... We need help with ...",
